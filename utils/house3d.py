...
class House3DUtils():
    ...
    # One step in the DATASET continuous coordinate system however, can be
    ...
    # an equivalent best-fit path in DATASET continuous coordinates
    ...
    def fit_grid_path_to_dataset(self, nodes, init_yaw=None, back_skip=2):
